...
const controlSearchResults = async function() {
    try {
        ...
        await _modelJs.loadSearchResults(query); // Not stored because doesn't return anything - just updates state.
        // 3 - render results
...
},{"core-js/modules/web.immediate.js":"49tUX","./model.js":"Y4A21","./views/recipeView.js":"l60JC","./views/searchView.js":"9OQAM","./views/resultsView.js":"cSbZE","./views/paginationView.js":"6z7bi","./views/bookmarksView.js":"4Lqzq","./views/previewView.js":"1FDQ6","./views/addRecipeView.js":"i6DNj","./config.js":"k5Hzs","regenerator-runtime/runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"49tUX":[function(require,module,exports) {
"use strict";
...
const updloadRecipe = async function(newRecipe) {
    try {
        const ingredients = Object.entries(newRecipe).filter((entry)=>entry[0].startsWith("ingredient") && entry[1] !== "").map((ingr)=>{
            // const ingrArr = ingr[1].replaceAll(' ', '').split(',');
            const ingrArr = ingr[1].split(",").map((el)=>el.trim());
            if (ingrArr.length !== 3) throw new Error('Wrong ingredient format, please use the correct format "Qty, Unit, Descr"');
            // console.log(ingrArr);
...
// Stores project wide variables that should be constants
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const API_KEY = "53100a40-f84a-4dd9-a891-da36c032a87c";
...
class RecipeView extends (0, _viewJsDefault.default) {
    ...
    addHandlerUpdateServings(handler) {
        this._parentElement.addEventListener("click", function(e) {
            ...
            if (!btn) return;
            const updateTo = +btn.dataset.updateTo; // btn.dataset.updateTo === data-update-to -> automagically converts dashed to camelcase ??
  ...
  <div class="recipe__directions">
    ...
    <div class="recipe__quantity">${ingr.quantity ? (0, _fractyDefault.default)(ingr.quantity).toString() : ""}</div>
...
},{"url:../../img/icons.svg":"loVOp","./view.js":"bWlJ9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","fracty":"hJO4d"}],"loVOp":[function(require,module,exports) {
...
},{"./previewView.js":"1FDQ6","./view.js":"bWlJ9","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1FDQ6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./view.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
class PaginationView extends (0, _viewDefault.default) {
    ...
    _generateMarkup() {
        ...
        if (this._data.page === 1 && numPages > 1) return this._generateMarkupNextButton(curPage);
        // Last page
        if (this._data.page === numPages && numPages > 1) return this._generateMarkupPrevButton(curPage);
        // Other page
        if (this._data.page < numPages) return this._generateMarkupPrevButton(curPage).concat(this._generateMarkupNextButton(curPage));
...
},{"./previewView.js":"1FDQ6","./view.js":"bWlJ9","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"i6DNj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./view.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
},{"./view.js":"bWlJ9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["kYpTN","aenu9"], "aenu9", "parcelRequire7e89")
